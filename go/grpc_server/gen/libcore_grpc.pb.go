...
func (c *libcoreServiceClient) BuildConfig(ctx context.Context, in *BuildConfigReq, opts ...grpc.CallOption) (*BuildConfigResp, error) {
	out := new(BuildConfigResp)
	err := c.cc.Invoke(ctx, LibcoreService_BuildConfig_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *libcoreServiceClient) ParseSubscription(ctx context.Context, in *ParseSubReq, opts ...grpc.CallOption) (*ParseSubResp, error) {
	out := new(ParseSubResp)
	err := c.cc.Invoke(ctx, LibcoreService_ParseSubscription_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *libcoreServiceClient) GenerateShareLink(ctx context.Context, in *ShareLinkReq, opts ...grpc.CallOption) (*ShareLinkResp, error) {
	out := new(ShareLinkResp)
	err := c.cc.Invoke(ctx, LibcoreService_GenerateShareLink_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedLibcoreServiceServer) BuildConfig(context.Context, *BuildConfigReq) (*BuildConfigResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method BuildConfig not implemented")
}
func (UnimplementedLibcoreServiceServer) ParseSubscription(context.Context, *ParseSubReq) (*ParseSubResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ParseSubscription not implemented")
}
...
func _LibcoreService_BuildConfig_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BuildConfigReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LibcoreServiceServer).BuildConfig(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: LibcoreService_BuildConfig_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LibcoreServiceServer).BuildConfig(ctx, req.(*BuildConfigReq))
	}
	return interceptor(ctx, in, info, handler)
}

func _LibcoreService_ParseSubscription_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ParseSubReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LibcoreServiceServer).ParseSubscription(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: LibcoreService_ParseSubscription_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LibcoreServiceServer).ParseSubscription(ctx, req.(*ParseSubReq))
	}
	return interceptor(ctx, in, info, handler)
}

func _LibcoreService_GenerateShareLink_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ShareLinkReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LibcoreServiceServer).GenerateShareLink(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: LibcoreService_GenerateShareLink_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LibcoreServiceServer).GenerateShareLink(ctx, req.(*ShareLinkReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var LibcoreService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _LibcoreService_BuildConfig_Handler,
		},
		{
			MethodName: "ParseSubscription",
			Handler:    _LibcoreService_ParseSubscription_Handler,
		},
		{
